...
namespace TR5TrainerTest
{
	...
	[StructLayout(LayoutKind.Sequential, Pack = 1)]
	public unsafe struct WINAPP
	{
		public void* hInstance;
        public void* WindowHandle;
        public WNDCLASS WindowClass;
		...
		public void* lpDD;             // DirectDraw2 Interface
		public void* lpD3D;              // Direct3D2 Interface
		public void* lpD3DDevice;      // Direct 3D2 Device
		public void* lpD3DDevice_BIS;  // Direct 3D2 Device

		public void* lpFrontBuffer;     // Primary Surface
		public void* lpBackBuffer;      // Back Buffer
		public void* lpZBuffer;         // Z Buffer

		public void* lpViewPort;
		...
		public RECT GnClientRect;
		public RECT GnWindowRect;

		public uint Flags;
		public uint DXWndStyle;
		public uint DXCoopLevel;

		public void* lpDI;
		public void* lpDIKeyboard;
		public void* lpDIJoystick;

		public void* GhWnd; // pos 100 s 4
		public uint isInScene; // pos 104 s 4
		public uint bNoFocus;             // Application Window Has Fous

		public uint sceneDone;
		public void* hObject; // D9AC05

		public float fps;
		public uint uint_D9AC0D;
		public uint uint_D9AC11;

        public void* hAccTable;
		public byte GameInitialized;
		public byte tBumpMap;
		public uint textRes;
		public uint bumpRes;
		public byte MMXSupport;
		public byte tBilinearFilter;
		public byte tVolumetricShadows;
		public byte tDisableSound;
		public uint orig_flags;
		public byte PlayingFMV;
		public uint OriginalBPP;

		public byte tAutoTarget;
        public fixed byte padd[3];
		public uint uint_D9AC34;
		public uint uint_D9AC38;

		public void* Palette;                // Palette For SW Renderer
		public fixed byte pad111[272];
		public D3DMATRIX ViewMatrix;
		public fixed byte pad112[4];
		public uint unk11200001;
		public uint DrawPrimitiveCnt;
		public int ResChangeTimer;
		public ushort* AnimTextureRanges;
		public fixed byte pad1121[4];
		public D3DMATRIX WorldMatrix;
		public fixed byte pad113[8];
		public uint fps_counter;
		public float fps_static;
		public fixed byte pad114[584];


		public byte bRender;           // Ok To Render

		public int nRenderMode;        // Hardware/Internal Renderer
		public int nUVAdd;

		public byte tJoystickEnabled;
		public int Joystick;

		public float fps_weird;
	}
